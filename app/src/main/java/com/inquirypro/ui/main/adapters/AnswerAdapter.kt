...
import com.inquirypro.databinding.AdapterAnswerBinding
import com.inquirypro.model.QuestionResult

class AnswerAdapter(val isCorrect: Boolean) : RecyclerView.Adapter<AnswerAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: AdapterAnswerBinding) :
